...
// Not a conflict in substance: SetFinalChosenTarget above arrived with
// expansion 1.16.4, which fisham-org's 1.16.1 base predates, so both sides
// simply added a function at the same spot. Both are kept.

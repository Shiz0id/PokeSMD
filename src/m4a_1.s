...
@ SoundMainRAM, SoundMainRAM_Unk1 and SoundMainRAM_Unk2 lived here, in a
@ .iwram.code section of their own. They are replaced by ipatix's HQ mixer
@ in src/m4a_hq_mixer.s, which defines the same SoundMainRAM symbol. Deleted
@ rather than left unreferenced: they shared one section, so --gc-sections
@ could not reclaim the 1796 bytes of IWRAM, which is the binding constraint.

...
@   ENABLE_DMA    1 -> 0  upstream warns the DMA path can crash games that do
@                         not expect the register writes, and pokeemerald has
@                         its own DMA3 manager plus HBlank effects. Costs 104
@                         bytes of IWRAM to remove the whole class of risk.

...
static bool8 DecompressGraphics(void)
{
    ...
    case 7:
        ...
        break;
    case 8:
        // IS_AWR was the host hack's alias for IS_FRLG; see the note in
        // include/bw_summary_screen.h. Always false on an Emerald build, so the
        // _AWR palette below is dead here -- kept so the pair stays intact if
        // anyone ever builds this for FRLG.
        if (IS_FRLG)

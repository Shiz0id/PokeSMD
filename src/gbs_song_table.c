...
const struct Song gGBSSongTable[GBS_MUSIC_COUNT] = {
    ...
    [GBS_MUSIC_ABNORMAL_WEATHER_PSG] = SONG(mus_abnormal_weather_gb, 0),
    [GBS_MUSIC_AQUA_MAGMA_HIDEOUT_PSG] = SONG(mus_aqua_magma_hideout_gb, 0),
    [GBS_MUSIC_CAVE_OF_ORIGIN_PSG] = SONG(mus_cave_of_origin_gb, 0),
    [GBS_MUSIC_EVER_GRANDE_PSG] = SONG(mus_ever_grande_gb, 0),
    [GBS_MUSIC_MT_CHIMNEY_PSG] = SONG(mus_mt_chimney_gb, 0),
    [GBS_MUSIC_MT_PYRE_PSG] = SONG(mus_mt_pyre_gb, 0),
    [GBS_MUSIC_MT_PYRE_EXTERIOR_PSG] = SONG(mus_mt_pyre_exterior_gb, 0),
    [GBS_MUSIC_ROUTE111_PSG] = SONG(mus_route111_gb, 0),

...
static void SetUpPlacingDecorationPlayerAvatar(u8 taskId, struct PlaceDecorationGraphicsDataBuffer *data)
{
    ...
    sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(GetPlayerDecoratingGfxId(), SpriteCallbackDummy, x, 72, 0);
...
static void SetUpPuttingAwayDecorationPlayerAvatar(void)
{
    ...
    sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(GetPlayerDecoratingGfxId(), SpriteCallbackDummy, 136, 72, 0);

...
// MAX_TRAINERS_COUNT_EMERALD has since been raised. THIRTEEN are spare, not the
// 57 this line claimed until the Johto and Sinnoh ports spent them: the count is
// 907 against a ceiling of 920. See the note on it below before spending them,
// and docs/TEAM_MINIBOSSES.md for what is already queued up to want them.
...
// The Kanto finale, and the ONE trainer in this block that is authored rather
// than ported. TRAINER_RED (851) already exists and is NOT this: it is FRLG's
// intro placeholder, class Rival, holding a single level-5 Charmander. Taking
// it would have put a lone Charmander on floor 115.
//
// The party is the Mt. Silver team at its GSC levels, and those levels are why
// this slot works at all: Pikachu 81, Espeon 73, Snorlax 75, Venusaur 77,
// Charizard 77, Blastoise 77 averages 76.7, against Steven's 76.3. The finale
// needed no scaling in either direction - verify_run_structure.py check 7 is
// what proves that, not this comment. All six species were confirmed in
// PokeSMD.map before the party was written, because a disabled family still
// compiles into a zeroed species_info row.
//
// Class is Champion Frlg so the prize money and mugshot match Blue's, and so
// gen_trainer_table.py excludes him by class as well as by the ^TRAINER_ROGUE_
// prefix. His battle music is set explicitly in sDungeonBossMusic rather than
// left to the class, for exactly the reason Steven's is.
#define TRAINER_ROGUE_KANTO_RED             876

// The Johto set: eight leaders, the Elite Four, Lance, and two authored.
// Parties are GENERATED by tools/rogue/gen_johto_parties.py - edit the tool, not
// trainers.party, the same rule PROGRAM_13_SPLIT.md carries.
//
// KOGA AND BRUNO GET THEIR OWN IDS despite already existing as Kanto Elite Four.
// They are the same characters and different trainers: Koga's Gen 2 team is
// Ariados, Venomoth, Forretress, Muk and Crobat against FireRed's Koffing and
// Weezing, and he is eight levels higher. Reusing the Kanto ids would have made
// a Johto run fight the FireRed teams under the Gen 2 sprites.
//
// LEVELS ARE SCALED, unlike Kanto's, and the tool explains why: Johto's stock
// late game is 5-10 levels UNDER this curve rather than over it, which does not
// make a hard fight, it makes floor 105 a pushover. Slots 0-5 are untouched.
//
// ETHAN IS THE FINALE BECAUSE RED IS ALREADY KANTO'S. SILVER is the rival and
// is levelled for the floor-110 slot he cannot occupy yet - the run's rival is
// still the fixed TRAINER_ROGUE_RIVAL, and making that regional is its own
// change. He is a drop-in for the day it happens.
#define TRAINER_ROGUE_JOHTO_FALKNER         877
#define TRAINER_ROGUE_JOHTO_BUGSY           878
#define TRAINER_ROGUE_JOHTO_WHITNEY         879
#define TRAINER_ROGUE_JOHTO_MORTY           880
#define TRAINER_ROGUE_JOHTO_CHUCK           881
#define TRAINER_ROGUE_JOHTO_JASMINE         882
#define TRAINER_ROGUE_JOHTO_PRYCE           883
#define TRAINER_ROGUE_JOHTO_CLAIR           884
#define TRAINER_ROGUE_JOHTO_WILL            885
#define TRAINER_ROGUE_JOHTO_KOGA            886
#define TRAINER_ROGUE_JOHTO_BRUNO           887
#define TRAINER_ROGUE_JOHTO_KAREN           888
#define TRAINER_ROGUE_JOHTO_LANCE           889
#define TRAINER_ROGUE_JOHTO_ETHAN           890
#define TRAINER_ROGUE_JOHTO_SILVER          891

// The Sinnoh set. Parties are GENERATED by tools/rogue/gen_sinnoh_parties.py -
// edit the tool, not trainers.party.
//
// PLATINUM'S GYM ORDER, not Diamond/Pearl's. DP puts Maylene third against a
// curve of 19 with a level 32 Lucario; Platinum reorders to Roark, Gardenia,
// Fantina, Maylene, Crasher Wake, Byron, Candice, Volkner and the ramp is
// smooth. The identity order here is Platinum's.
//
// LEVELS ARE SCALED DOWN, which is the opposite direction from Johto and a
// change of policy from Kanto. Sinnoh's stock teams run a uniform +5 to +8 OVER
// this curve - not two outlier rows, which is what a wider tolerance honestly
// covers, but a different curve across thirteen of them. Three regions each
// with their own allowance stops being a check and becomes a list of excuses.
//
// DAWN IS THE FINALE and BARRY THE RIVAL, the same shape as Ethan and Silver.
// Dawn's roster is her ANIME team fully evolved - Empoleon, Togekiss,
// Mamoswine, Typhlosion, Lopunny, Ambipom - because there is no game Dawn to
// copy, she is a player character. Barry's starter is the one that beats hers.
#define TRAINER_ROGUE_SINNOH_ROARK          892
#define TRAINER_ROGUE_SINNOH_GARDENIA       893
#define TRAINER_ROGUE_SINNOH_FANTINA        894
#define TRAINER_ROGUE_SINNOH_MAYLENE        895
#define TRAINER_ROGUE_SINNOH_CRASHER_WAKE   896
#define TRAINER_ROGUE_SINNOH_BYRON          897
#define TRAINER_ROGUE_SINNOH_CANDICE        898
#define TRAINER_ROGUE_SINNOH_VOLKNER        899
#define TRAINER_ROGUE_SINNOH_AARON          900
#define TRAINER_ROGUE_SINNOH_BERTHA         901
#define TRAINER_ROGUE_SINNOH_FLINT          902
#define TRAINER_ROGUE_SINNOH_LUCIAN         903
#define TRAINER_ROGUE_SINNOH_CYNTHIA        904
#define TRAINER_ROGUE_SINNOH_DAWN           905
#define TRAINER_ROGUE_SINNOH_BARRY          906

// GEN 1 TEAM ROCKET, for the mini boss roster. Fifty-three trainers at levels
// 11-54, GENERATED by tools/rogue/gen_rocket_parties.py -- run it with --ids to
// re-derive this block and --check to prove trainers.party has not drifted from
// the FRLG source it was copied out of.
//
// THE PARTIES WERE ALREADY IN THE TREE AND ALREADY UNREACHABLE.
// src/data/trainers_frlg.party holds every one of these, and gTrainers is
// `#if IS_FRLG` -- one table or the other, never both. So they had no ids, no
// flags and nothing that could reference them, while their battle pics compiled
// the whole time because the pic table is not gated the same way. See
// docs/TEAM_MINIBOSSES.md.
//
// WHY THE WHOLE SET RATHER THAN A CURATED SUBSET: a mini boss is picked BY
// DEPTH from a roster sorted on level, so what this buys is the top of that
// roster. Aqua and Magma stop at 43 while the last gym dungeon asks for 45, and
// Rocket runs to 54.
#define TRAINER_ROGUE_ROCKET_GRUNT_1   907
#define TRAINER_ROGUE_ROCKET_GRUNT_2   908
#define TRAINER_ROGUE_ROCKET_GRUNT_3   909
#define TRAINER_ROGUE_ROCKET_GRUNT_4   910
#define TRAINER_ROGUE_ROCKET_GRUNT_5   911
#define TRAINER_ROGUE_ROCKET_GRUNT_6   912
#define TRAINER_ROGUE_ROCKET_GRUNT_7   913
#define TRAINER_ROGUE_ROCKET_GRUNT_8   914
#define TRAINER_ROGUE_ROCKET_GRUNT_9   915
#define TRAINER_ROGUE_ROCKET_GRUNT_10  916
#define TRAINER_ROGUE_ROCKET_GRUNT_11  917
#define TRAINER_ROGUE_ROCKET_GRUNT_12  918
#define TRAINER_ROGUE_ROCKET_GRUNT_13  919
#define TRAINER_ROGUE_ROCKET_GRUNT_14  920
#define TRAINER_ROGUE_ROCKET_GRUNT_15  921
#define TRAINER_ROGUE_ROCKET_GRUNT_16  922
#define TRAINER_ROGUE_ROCKET_GRUNT_17  923
#define TRAINER_ROGUE_ROCKET_GRUNT_18  924
#define TRAINER_ROGUE_ROCKET_GRUNT_19  925
#define TRAINER_ROGUE_ROCKET_GRUNT_20  926
#define TRAINER_ROGUE_ROCKET_GRUNT_21  927
#define TRAINER_ROGUE_ROCKET_GRUNT_22  928
#define TRAINER_ROGUE_ROCKET_GRUNT_23  929
#define TRAINER_ROGUE_ROCKET_GRUNT_24  930
#define TRAINER_ROGUE_ROCKET_GRUNT_25  931
#define TRAINER_ROGUE_ROCKET_GRUNT_26  932
#define TRAINER_ROGUE_ROCKET_GRUNT_27  933
#define TRAINER_ROGUE_ROCKET_GRUNT_28  934
#define TRAINER_ROGUE_ROCKET_GRUNT_29  935
#define TRAINER_ROGUE_ROCKET_GRUNT_30  936
#define TRAINER_ROGUE_ROCKET_GRUNT_31  937
#define TRAINER_ROGUE_ROCKET_GRUNT_32  938
#define TRAINER_ROGUE_ROCKET_GRUNT_33  939
#define TRAINER_ROGUE_ROCKET_GRUNT_34  940
#define TRAINER_ROGUE_ROCKET_GRUNT_35  941
#define TRAINER_ROGUE_ROCKET_GRUNT_36  942
#define TRAINER_ROGUE_ROCKET_GRUNT_37  943
#define TRAINER_ROGUE_ROCKET_GRUNT_38  944
#define TRAINER_ROGUE_ROCKET_GRUNT_39  945
#define TRAINER_ROGUE_ROCKET_GRUNT_40  946
#define TRAINER_ROGUE_ROCKET_GRUNT_41  947
#define TRAINER_ROGUE_ROCKET_GRUNT_42  948
#define TRAINER_ROGUE_ROCKET_GRUNT_43  949
#define TRAINER_ROGUE_ROCKET_GRUNT_44  950
#define TRAINER_ROGUE_ROCKET_GRUNT_45  951
#define TRAINER_ROGUE_ROCKET_GRUNT_46  952
#define TRAINER_ROGUE_ROCKET_GRUNT_47  953
#define TRAINER_ROGUE_ROCKET_GRUNT_48  954
#define TRAINER_ROGUE_ROCKET_ADMIN_1   955
#define TRAINER_ROGUE_ROCKET_ADMIN_2   956
#define TRAINER_ROGUE_ROCKET_GRUNT_49  957
#define TRAINER_ROGUE_ROCKET_GRUNT_50  958
#define TRAINER_ROGUE_ROCKET_GRUNT_51  959

#define TRAINERS_COUNT_EMERALD     960
...
// RAISED AGAIN, 920 -> 1040, AND THE COST WAS MEASURED BY BUILDING IT BOTH
// WAYS RATHER THAN PREDICTED FROM THE ARITHMETIC ABOVE:
//
//     ROM     29,231,888 -> 29,252,128   +20,240 B
//     EWRAM      246,028 ->    246,040       +12 B
//     IWRAM       19,444 ->     19,444         0
//     SaveBlock1  14,000 ->     14,012       +12 B, against a 15,872 cap
//
// AND THE ROM COST IS NOT gTrainers, WHICH DOES NOT MOVE -- it is sized by
// TRAINERS_COUNT, the real count, not by this ceiling. Every byte of it is
// sTrainerSlides in src/trainer_slide.c, which is
// [DIFFICULTY_COUNT][TRAINER_PARTNER(PARTNER_COUNT)][TRAINER_SLIDE_COUNT]:
// 3 x 14 x 4 = 168 BYTES OF ROM PER TRAINER ID, paid whether the id exists or
// not, in a table that is almost entirely NULL. It is 175 KB now. If ROM ever
// becomes the constraint, that table is where 100+ KB is hiding.
//
// The flag side is not the wall the stock note makes it sound: 120 ids cost
// twelve bytes of SaveBlock1 and leave 1,860 free, which is thousands of ids of
// headroom. Flags were never what limited this.
//
// Spent on: 53 Gen 1 Rocket (907-959). EIGHTY LEFT, earmarked for Gen 2 Rocket
// and Team Galactic -- see docs/TEAM_MINIBOSSES.md for what each still needs.
#define MAX_TRAINERS_COUNT_EMERALD 1040

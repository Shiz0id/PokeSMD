...
// ---------------------------------------------------------------------------
// gTileset_RogueFlowerMeadow - Wallace's, dungeon 12. Western Cave dark's
// flowering hedge over Purity Forest's grass, with Western Cave dark's stone as
// the plaza. Generated by tools/rogue/import_tile_sheet.py; every id here comes
// from `--decls` and none may be hand-edited, because the importer OWNS that
// directory and rewrites every id from the sheet on each run.
#define MEADOW_METATILE_FLOOR            0x251

#define MEADOW_METATILE_NORTH_LEFT       0x200
#define MEADOW_METATILE_NORTH_MID        0x201
#define MEADOW_METATILE_NORTH_RIGHT      0x202
#define MEADOW_METATILE_INTERIOR_LEFT    0x203
#define MEADOW_METATILE_INTERIOR_MID     0x204
#define MEADOW_METATILE_INTERIOR_RIGHT   0x205
#define MEADOW_METATILE_FACE_LEFT        0x206
#define MEADOW_METATILE_FACE_MID         0x207
#define MEADOW_METATILE_FACE_RIGHT       0x208
#define MEADOW_METATILE_CORNER_OPEN_SE   0x21D
#define MEADOW_METATILE_CORNER_OPEN_SW   0x21E
#define MEADOW_METATILE_CORNER_OPEN_NE   0x21F
#define MEADOW_METATILE_CORNER_OPEN_NW   0x220

// ALL SEVEN ARE REAL ART, and this is the theme that had none: its vertical
// slivers were fallbacks onto WALL_INTERIOR_M, which is the only reason
// corridorWidth is 5 - five is what stopped them ever firing.
#define MEADOW_METATILE_SLIVER_HORZ      0x20A
#define MEADOW_METATILE_SLIVER_VERT      0x20C
#define MEADOW_METATILE_SLIVER_ISOLATED  0x20D
#define MEADOW_METATILE_SLIVER_VERT_TOP  0x210
#define MEADOW_METATILE_SLIVER_HORZ_L    0x211
#define MEADOW_METATILE_SLIVER_HORZ_R    0x213
#define MEADOW_METATILE_SLIVER_VERT_BOT  0x214

// The plaza, a real nine-sliced region rather than the path it replaces. The
// vanilla terrace was left edge / fill / right edge with NO north or south art,
// so a plaza blob had hard cuts top and bottom - gap 4.
#define MEADOW_METATILE_PLAZA_NW         0x27E
#define MEADOW_METATILE_PLAZA_N          0x27F
#define MEADOW_METATILE_PLAZA_NE         0x280
#define MEADOW_METATILE_PLAZA_W          0x281
#define MEADOW_METATILE_PLAZA_MID        0x282
#define MEADOW_METATILE_PLAZA_E          0x283
#define MEADOW_METATILE_PLAZA_SW         0x284
#define MEADOW_METATILE_PLAZA_S          0x285
#define MEADOW_METATILE_PLAZA_SE         0x286

// The TALL encounter surface, MB_LONG_GRASS, and its south fringe, which carries
// MB_LONG_GRASS_SOUTH_EDGE and therefore NO encounters - exactly as vanilla.
// Blades recoloured from the hedge palette, ground band from the imported grass.
#define MEADOW_METATILE_GRASS            0x2AD
#define MEADOW_METATILE_FRINGE           0x2AE

// The SHORT encounter surface, MB_UNUSED_05, in two colourways that vanilla
// never mixes on one field. EIGHT PHASES OF A DIAGONAL BANDING, not eight
// variants, so each set must stay contiguous and ascending - phase indexes off
// the first id.
#define MEADOW_METATILE_BEDPINK          0x2AF  // 0x2AF-0x2B6
#define MEADOW_METATILE_BEDYELLOW        0x2B7  // 0x2B7-0x2BE
#define MEADOW_FLOWER_PHASE              8

#define MEADOW_METATILE_STAIRS           0x2BF
